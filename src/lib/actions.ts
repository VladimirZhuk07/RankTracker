...
import { addUser, updateUserAvatar, updateUserStats, deleteUserById, getUserById, userExistsByName } from './storage/data';
import { User, UserStatsData } from './storage/definitions';
